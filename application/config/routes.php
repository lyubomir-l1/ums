...
$route['change_password/change_password'] = 'change_password/change_password';
...
$route['admin/remove_ban/(:num)'] = 'admin/remove_ban/$1';
$route['admin/change_user_permission_level/(:num)'] = 'admin/change_user_permission_level/$1';
